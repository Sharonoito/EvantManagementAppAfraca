...
//   // const attendeePortalUrl = `${siteUrl}/attendee/profile?qr=${encodeURIComponent(checkInURL)}`
//   const attendeePortalUrl = `${siteUrl}/attendee?email=${encodeURIComponent(user.email)}`
