      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: white; padding: 30px; border-radius: 0 0 10px 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
          ...
          <div style="background: #f8d7da; border: 1px solid #f5c2c7; padding: 15px; border-radius: 6px; margin: 20px 0;">
            <p style="margin: 0; color: #842029;"><strong>Important:</strong> You'll need to <b>scan this QR code</b> to check in before accessing your attendee portal.</p>
          </div>
          ...
          <div style="background: #f8f9fa; padding: 20px; border-radius: 8px; margin: 20px 0; text-align: center;">
            ...
            <p style="margin: 15px 0 5px 0; font-size: 14px; color: #6c757d;">Scan or click the code to check in</p>
          </div>
          
          <div style="background: #e3f2fd; padding: 20px; border-radius: 8px; margin: 20px 0;">
            <h3 style="margin-top: 0; color: #1976d2;">📱 Access Your Attendee Portal</h3>
            <p style="margin-bottom: 15px;">After completing check-in, open your personalized attendee dashboard:</p>
          ...
          <div style="border-left: 4px solid #28a745; padding-left: 20px; margin: 20px 0;">
            ...
            <ol style="margin: 0; padding-left: 20px;">
              <li>Scan or click the QR code above to check in</li>
              <li>Complete your check-in process</li>
              <li>Press "Open Attendee Portal" to access your profile</li>
...
export async function sendQRCodeEmail(
  ...
  const htmlContent = createQRCodeEmailTemplate(name, qrCodeDataUrl, checkInURL, qrCode)
